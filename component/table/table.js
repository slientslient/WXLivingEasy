...
Component({
  ...
  methods: {
    ...
    ready: function() {
      ...
      const theadWidth = this.getThredWidth(thead);
    ...
    getFixedCols: function () {
      ...
      console.log("fixedCols=="+JSON.stringify(result));
      return result;
    },
    ...
    */
     ...
     * 获取表头固定行的宽度
     */
    getThredWidth:function(thead){
      var width = 58+326*(thead.length-1)+50;
      var result = width+'rpx';
      ...
      // //选择id
      // var that = this;
      // query.select('#thead').boundingClientRect();
    ...
    cilckEvent:function(e){
  
        var detailData = e.currentTarget.dataset.item;
        this.triggerEvent('myEvent',detailData);
